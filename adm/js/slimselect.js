...
var Data = (function () {
    ...
    Data.prototype.newOption = function (info) {
        return {
            ...
            placeholder2: (info.placeholder2 ? info.placeholder2 : false),
            ...
            if (n.nodeName === 'OPTGROUP') {
                ...
                for (var _a = 0, options_1 = options; _a < options_1.length; _a++) {
                    ...
                    if (o.nodeName === 'OPTION') {
                        ...
                        if (option.placeholder2 && option.text.trim() !== '') {
                            this.main.config.placeholder2Text = option.text;
                        }
                    }
                }
    ...
    Data.prototype.pullOptionData = function (option) {
        return {
            ...
            placeholder2: option.dataset.placeholder2 === 'true',
    ...
    Data.prototype.getSelected = function () {
        var value = { text: '', placeholder2: this.main.config.placeholder2Text };
        var values = [];
        for (var _i = 0, _a = this.data; _i < _a.length; _i++) {
            var d = _a[_i];
            if (d.hasOwnProperty('label')) {
...
var SlimSelect = (function () {
    function SlimSelect(info) {
        ...
        this.config = new config_1.Config({
            ...
            placeholder2Text: info.placeholder2,
    ...
    SlimSelect.prototype.setData = function (data) {
        ...
        if (this.config.isAjax && selected) {
            if (this.config.isMultiple) {
                ...
                newData.unshift({ text: '', placeholder2: true });
            }
        }
                ...
                if (this.ajax) {
                    this.ajax(value, function (info) {
                        ...
                        if (Array.isArray(info)) {
                            info.unshift({ text: '', placeholder2: true });
...
var Config = (function () {
    function Config(info) {
        ...
        this.placeholder2Text = 'Select Value';
        ...
        if (info.placeholder2Text) {
            this.placeholder2Text = info.placeholder2Text;
        }
...
var Select = (function () {
    ...
    Select.prototype.createOption = function (info) {
        ...
        if (info.placeholder2) {
            optionEl.setAttribute('data-placeholder2', 'true');
        }
        if (info.mandatory) {
...
var Slim = (function () {
    ...
    Slim.prototype.placeholder2 = function () {
        var selected = this.main.data.getSelected();
        if (selected === null || (selected && selected.placeholder2)) {
            var placeholder2 = document.createElement('span');
            placeholder2.classList.add(this.main.config.disabled);
            placeholder2.innerHTML = this.main.config.placeholder2Text;
            if (this.singleSelected) {
                this.singleSelected.placeholder2.innerHTML = placeholder2.outerHTML;
            }
        }
        else {
            var selectedValue = '';
            ...
            if (this.singleSelected) {
                this.singleSelected.placeholder2.innerHTML = (selected ? selectedValue : '');
            }
        }
    };
    ...
    Slim.prototype.values = function () {
        ...
        if (selected.length === 0) {
            ...
            placeholder2.classList.add(this.main.config.disabled);
            placeholder2.innerHTML = this.main.config.placeholder2Text;
            this.multiSelected.values.innerHTML = placeholder2.outerHTML;
        }
    };
    ...
    Slim.prototype.searchDiv = function () {
        ...
        input.type = 'search';
        input.placeholder2 = this.main.config.searchPlaceholder;
        input.tabIndex = 0;
    ...
    Slim.prototype.option = function (data) {
        if (data.placeholder2) {
            ...
            placeholder2.classList.add(this.main.config.option);
            placeholder2.classList.add(this.main.config.hide);
            return placeholder2;
        }
