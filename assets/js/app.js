...
function buscar(predefinied = 0) {
  ...
  if(predefinied == 'comprar'){
    $('[value="1"][name="tipo_venta"]').prop('checked', true); tipo = 1;
  } 
  if(predefinied == 'rentar'){
    $('[value="2"][name="tipo_venta"]').prop('checked', true); tipo = 2;
  } 
  let params = {
    min_precio: min,
    max_precio: max,
    ...
    <div class="col-12 mb-4">
        <div class="card">
          <div class="row d-flex align-items-center">
            <div class="col-md-5">
              <img src="http://localhost/proyectos/constructora/img/propiedades/${objeto.ruta_imagen}" class="card-img" alt="Imagen">
            </div>
            <div class="col-md-7">
...
let timeoutId;
$(document).on('input', '[name="tipo_venta"],[name="tipo_prop"],.propiedad_cont input', function() {
  $('#prop_html').html(
